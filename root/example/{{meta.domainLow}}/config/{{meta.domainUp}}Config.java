...
import {{meta.package}}.domain.{{meta.domainLow}}.usecases.Find{{meta.domainUp}}UseCase;
...
public class {{meta.domainUp}}Config {
    ...
    private final Find{{meta.domainUp}}UseCase find{{meta.domainUp}}UseCase;
    ...
    public {{meta.domainUp}}Config({{meta.domainUp}}Repository {{meta.domainLow}}Repository, {{meta.domainUp}}IdGenerator<?> {{meta.domainLow}}IdGenerator) {
        ...
        this.find{{meta.domainUp}}UseCase = new Find{{meta.domainUp}}UseCase({{meta.domainLow}}Repository);
    }
}
