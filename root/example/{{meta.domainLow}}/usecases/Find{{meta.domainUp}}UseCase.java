 ...
 * Поиск по коллекции
 */
public class Find{{meta.domainUp}}UseCase extends AbstractFindWithFiltersUseCase<{{meta.domainUp}}Entity, {{meta.domainUp}}Filters, {{meta.domainUp}}Repository> {

    public Find{{meta.domainUp}}UseCase({{meta.domainUp}}Repository repository) {
        super(repository);
    }
}